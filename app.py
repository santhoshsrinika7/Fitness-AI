...
def chat():
    ...
    if "protein" in user_message:
        ...
        if context.get("diet_type") == "Vegetarian":
            ...
            reply = (
                "Best vegetarian protein sources are Paneer, Soy Chunks, "
                "Tofu, Milk, Lentils, Chickpeas and Sprouts."
            )

        else:

            reply = (
                "Best non-vegetarian protein sources are Eggs, Chicken, "
                "Fish and Lean Meat."
            )
        ...
        reply = (
            "Ask me about Diet, Workout, Water, Sleep, BMI or Calories."
        )
